...
#change
SRCREV_machine_qemux86-64 ?= "e10d104af52def41e75debd30a9e1ba45156bcf3"
...
SRC_URI = "git://git.kernel.org/pub/scm/linux/kernel/git/aia21/ntfs.git;protocol=git;nocheckout=1;name=machine; \
...
LINUX_VERSION ?= "4.13-rc1"

PV = "${LINUX_VERSION}+git${SRCPV}"
B = "${WORKDIR}/linux-${PACKAGE_ARCH}-${LINUX_KERNEL_TYPE}-build"
S = "${WORKDIR}/linux-${PACKAGE_ARCH}-${LINUX_KERNEL_TYPE}"
